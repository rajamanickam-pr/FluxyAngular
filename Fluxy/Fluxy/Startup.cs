...
using Fluxy.ViewModels;
using Fluxy.Helpers;
using Fluxy.Policies;
...
namespace Fluxy
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Fluxy"));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new Info { Title = "Fluxy API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Fluxy API V1");
            });
